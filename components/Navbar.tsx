    ...
    return (
        <div className="sticky top-0 z-50">
            <div className="hidden lg:block">
                <div className='bg-[#77896F] w-screen h-[70px] px-20 py-2 flex items-center justify-between'>
                    <div className='text-white flex items-center gap-1 text-[20px]'>
                    ...
                    <button type="button" className="flex items-center justify-between gap-2 text-white text-[20px]">
                        <span>Join our workshop</span>
                        <BsArrowUpRightCircle />
                    </button>
                </div>
                <nav className="flex items-center justify-between px-32 py-8 bg-white text-[20px]">
                    ...
                    <div className="relative w-[235px] h-[68px]">
            ...
            <div className="lg:hidden block">
                <div className='bg-[#77896F] h-[103px] w-screen px-16 py-4 text-white flex flex-col items-center gap-4 text-xs'>
